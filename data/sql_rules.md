...
LINE_CODE 컬럼을 조회할 때는 반드시 **f_get_line_name 함수**를 사용하여 라인명을 표시해야 합니다.
...
SELECT 
    ...
    SUM(...) as DEFECT_COUNT
FROM table_name
GROUP BY f_get_line_name(line_code, 1)
